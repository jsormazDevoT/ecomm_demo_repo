...
## Aggregate tables for demo

explore: +order_items {
  aggregate_table: orders {
    query: {
      dimensions: [
        created_date,
        order_id,
...
explore: +order_items {
  aggregate_table: orders_by_product_category {
    query: {
      dimensions: [
        created_date,
        order_id,
...
explore: +order_items {
  aggregate_table: sven_casper {
    query: {
      dimensions: [delivered_month, distribution_centers.location, status, distribution_centers.name]
      measures: [count]
      filters: []
    }
